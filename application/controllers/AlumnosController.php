            ...
            if (empty($usuario)) {
                ...
                try {
                    ...
                    if (!$alumnosverifica) {
                        ...
                        /* RQM 126 */
                        $alumnos->agregar($rut, $nombres, $apaterno, $amaterno, $sexo, $fechanacimiento, $nacionalidad, $etnia, $pais, $ciudadnacimiento, $curso);
                        ...
                        /* RQM 126 */
                        $numerocasa = $numerocasa === "" ? 0 : $numerocasa;
                        /* FIN RQM 126 */
        ...
        try {
            ...
            for ($row = 1; $row <= $lastRow; $row++) {
                ...
                if ($row > 1) {
                    ...
                    // var_dump($worksheet->getCell('F' . $row)->getValue());
                    // var_dump('</pre>');
                    if (!is_null($worksheet->getCell('C' . $row)->getValue())) {
                        ...
                        try {
                            ...
                            if (!$verifica) {
                                ...
                                $modelalumnos->agregar($rut, $nombres, $apaterno, $amaterno,  $sexo, $fechanacimiento,$nacionalidad,$etnia,$pais, $ciudad, $datoscurso[0]['idCursos']);
                                ...
                                $ultimo = $modelalumnosactual->ultimo($datoscurso[0]['idCursos'], $idperiodo);
                                $cantidadAlumnos = is_null($ultimo[0]['max']) ? 0 : $ultimo[0]['max'];
                                ...
                                if (!$verificaactual) {
                                /* FIN RQM 200 */
                                    $modelalumnosactual->agregar($idalumnos[$row], $datoscurso[0]['idCursos'], $idperiodo, $cantidadAlumnos + 1, $fechaincorporacion, $numeromatricula, $calle, $numerocasa, $villa, $ciudadactual, $telefono, $celular, $comuna, $correo, null, null, null, $tipoidentificacion);
                                }
