...
class HorariosController extends Zend_Controller_Action
{
    ...
    public function getformAction()
    {
        ...
        //Validamos la informacion si existe un asignacion en el dia y durante el rango de tiempo
        ...
        $this->_helper->json(array($listadocentes, $listaasignatura, $idhorario));
