...
class Application_Model_DbTable_Alumnos extends Zend_Db_Table_Abstract
{
    ...
    public function agregar($rut, $nombres, $apaterno, $amaterno, $sexo, $fechanacimiento, $nacionalidad, $etnia, $pais, $ciudad, $idCurso)
    {
        $data = array('rutAlumno' => $rut, 'nombres' => $nombres, 'apaterno' => $apaterno, 'amaterno' => $amaterno, 'sexo' => $sexo, 'fechanacimiento' => $fechanacimiento, 'procedencia' => 0, 'nacionalidad' => $nacionalidad, 'etnia' => $etnia, 'paisNacimiento' => $pais, 'ciudadNacimiento' => $ciudad, 'idCursos' => $idCurso);
