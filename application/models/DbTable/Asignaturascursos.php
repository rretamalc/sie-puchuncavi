...
class Application_Model_DbTable_Asignaturascursos extends Zend_Db_Table_Abstract
{
    ...
    public function agregar($idasignatura, $tipoasignatura, $orden, $promedio, $nucleo, $idperiodo, $idcurso, $horas, $horasAsignadas)
    {
        $data = array('idAsignatura' => $idasignatura, 'tipoAsignatura' => $tipoasignatura, 'orden' => $orden, 'promedio' => $promedio, 'estado' => 1, 'idNucleo' => $nucleo, 'idPeriodo' => $idperiodo, 'idCursos' => $idcurso,'prioritaria'=>0, 'horas' => $horas, 'horasAsignadas' => $horasAsignadas);
        $this->insert($data);
    }
    ...
    public function cambiarestadoorden($idasignatura, $orden,$prioritaria,$horas)
    {
        $data = array('orden' => $orden,'prioritaria'=>$prioritaria,'horas'=> $horas);
        $this->update($data, 'idAsignaturaCurso = ' . (int)$idasignatura);
    }
